  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative overflow-hidden bg-white pt-[124px] md:pt-[140px] pb-16 border-b border-[#e8e8e8]">
        {/* Decorative backdrop — same grid texture as the legal pages */}
        <div
          aria-hidden="true"
        ...
        <div className="relative mx-auto max-w-[1200px] px-6 text-center">
          <h1 className="mx-auto max-w-[820px] font-serif text-[40px] md:text-[56px] lg:text-[64px] font-bold leading-[1.03] tracking-[-0.025em] text-[#1a1a1a]">
